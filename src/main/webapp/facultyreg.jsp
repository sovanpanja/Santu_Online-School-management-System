...
<%@page import="java.util.regex.*,com.backend.facultydb.*"%>
</head>
<body>
	<%
	...
	if (fName.equals("") || lName.equals("") || dept.equals("Select Department") || dob.equals("") || gender.equals("")
			...
			|| doj.equals("")) {
	%>
	<jsp:include page="facultyReg.html" />
	<%
	...
	try {
	int i = obj.insertData(mob,fName, lName, dept, dob, gender, gName, city, mail, pass, doj, cat);
	if (i > 0) {
		%>
